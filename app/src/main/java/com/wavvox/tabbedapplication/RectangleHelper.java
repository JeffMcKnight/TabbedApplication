...
//        }
    ...
    public static void populateMap(Map<Integer, List<Integer>> adjacentMap, int adjacentSide, int oppositeSide) {
    ...
    public static boolean isRectangle(IntegerPoint point0, IntegerPoint point1, IntegerPoint point2, IntegerPoint point3) {
    ...
    public static IntegerPoint[] testPoints(int count, boolean insertTestPoints){
        ...
        for (int i = 0; i < count; i++) {
            points[i] = new IntegerPoint(((int) (Integer.MAX_VALUE * Math.random())), (int) (Integer.MAX_VALUE * Math.random()));
        }
        if (insertTestPoints){
